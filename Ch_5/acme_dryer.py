...
def startup_message():
    ...
    print('disassemble and ACME laundry dryer.')
    print('There are 4 steps in the process.')
    print()

# The step1 dunction displays the instructions
# for step 1.
def step1():
...
# The step2 dunction displays the instructions
# for step 2.
def step2():
...
# The step3 dunction displays the instructions
# for step 3.
def step3():
...
# The step4 dunction displays the instructions
# for step 4.
def step4():
